...
class Scene final : public batteries::Scene
{
  ...
  private:
    ...
    std::unique_ptr<ew::Shader> edge_detection;
    std::unique_ptr<ew::Shader> sharpen;
    std::unique_ptr<ew::Shader> chromaticaberration;
    std::unique_ptr<ew::Shader> vignette;
    std::unique_ptr<ew::Shader> hdr;
    std::unique_ptr<ew::Shader> filmgrain;
    std::unique_ptr<ew::Shader> fisheye;
    std::unique_ptr<ew::Shader> fog;
